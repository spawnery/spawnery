...
[`docs/superpowers/specs/`](https://github.com/spawnery/spawnery/tree/master/docs/superpowers/specs)
on GitHub.

Nothing in this section tells you how to run Spawnery today. For that, start
with the [tutorial](../tutorial/index.md), then the
[guides](../guides/expose-strategies.md); the
[reference](../reference/crds.md) is generated from the code and is the only
