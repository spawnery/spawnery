...
[The /cloud command](../guides/cloud-command.md). The
...
image rebuild and a release. [`plugins.md`](../guides/plugins-from-a-volume.md) is the whole of it.
...
renders it: it is a [mount](../guides/mounts-and-files.md) like any other file, and `subPath` is how
...
[`docs/guides/plugins-from-a-volume.md`](../guides/plugins-from-a-volume.md) and [`docs/guides/mounts-and-files.md`](../guides/mounts-and-files.md) carry the
whole of it.
