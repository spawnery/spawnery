...
It is kept rather than compressed into a changelog because most of it is not a
list of what shipped. It is the record of what was *measured* against what was
assumed — which claims a cluster confirmed, which ones a mutation showed were
narrower than their design document said, and which defects were found by
...
- [Milestone 1](#milestone-1) — the CRDs, the controllers and the state machine
- [Milestone 2](#milestone-2) — the agent channel and the Paper image
- [Milestone 3](#milestone-3) — a player can join
...
Milestone 1 is done: the four CRDs, the operator with the
